# scroll background with speed

Sets the background image to scroll at a set speed. The background will loop when the scroll reaches the edges of the image.
...
In this example, we give the illusion of moving to the right by scrolling the background to the left. We also create obstacles that move at the same speed as the background and gradually increase the speed.
...
scene.setBackgroundImage(img`
    ...
    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    `)
scroller.scrollBackgroundWithSpeed(0 - speed, 0)
